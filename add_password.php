...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        if ($result['success']) {
            $success = 'Mot de passe ajouté avec succès.';
            // Réinitialiser les champs du formulaire
            $title = $username = $email = $password = $websiteUrl = $notes = '';
            $category = 'General';
            $favorite = false;
        } else {
...
<head>
    ...
    <title>Ajouter un mot de passe - <?php echo APP_NAME; ?></title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <section class="content-section">
                <form action="add_password.php" method="POST" class="password-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="website_url" name="website_url" value="<?php echo isset($websiteUrl) ? htmlspecialchars($websiteUrl) : ''; ?>">
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group checkbox-group">
                            <label>
                                <input type="checkbox" name="favorite" <?php echo (isset($favorite) && $favorite) ? 'checked' : ''; ?>>
